            ...
            <div class="row g-4 g-lg-5">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="footer-widget brand-widget">
                        ...
                        <p class="footer-about" data-lang-key="footer.about">
                            Pionir dalam menghadirkan solusi kesehatan dan kecantikan berbasis teknologi Stem Cell Apel
                            Swiss. Kami berkomitmen memberdayakan individu melalui produk premium dan peluang bisnis
                ...
                <div class="col-lg-2 col-md-6 col-6">
                    <div class="footer-widget">
                        ...
                        <ul class="footer-menu">
                            ...
                            <li><a href="#profil" class="scroll-link" data-lang-key="nav.about">Profil Perusahaan</a>
                            </li>
                            <li><a href="#produk" class="scroll-link" data-lang-key="nav.products">Katalog Produk</a>
                            </li>
                            <li><a href="#bisnis" class="scroll-link" data-lang-key="nav.business">Peluang Bisnis</a>
                            </li>
                            <li><a href="#media" class="scroll-link" data-lang-key="nav.media">Media & Event</a></li>
                            <li><a href="#registrasi" class="scroll-link" data-lang-key="nav.register">Registrasi</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="footer-widget">
                        ...
                        <ul class="footer-menu">
                            <li><a href="#produk" class="scroll-link" data-lang-key="product_names.nad_boost">Bio NAD+
                                    Boost</a></li>
                            <li><a href="#produk" class="scroll-link" data-lang-key="product_names.applesc_plus">AppleSC
                                    Plus</a></li>
                            <li><a href="#produk" class="scroll-link" data-lang-key="product_names.sc_mild">Bio SC
                                    Mild</a></li>
                            <li><a href="#produk" class="scroll-link" data-lang-key="product_names.sc_gold">Bio SC
                                    Gold</a></li>
                            <li><a href="#produk" class="scroll-link" data-lang-key="product_names.inflavia">Bio
                                    Inflavia</a></li>
                            <li><a href="#produk" class="scroll-link" data-lang-key="product_names.rawgenic">Bio
                                    Rawgenic</a></li>
                        </ul>
                    </div>
                </div>
                        ...
                        <ul class="footer-contact-list">
                            <li>
                                ...
                                <div class="contact-info">
                                    ...
                                    <p data-lang-key="footer.address">MENARA IMPERIUM LG NO. 09, JL. HR. RASUNA SAID KAV
                                        1, Desa/Kelurahan Guntur, Kec. Setiabudi, Kota Adm. Jakarta Selatan, Provinsi
                                        DKI Jakarta</p>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="contact-info">
                                    ...
                                    <a href="https://wa.me/62811959901">+62 811 9599 01</a>
                                </div>
                            </li>
                            <li>
        ...
        <div class="container">
            <div class="footer-bottom-wrapper">
                <div class="copyright-text">
                    &copy; <?php echo date('Y'); ?> <strong>BisnisonlineBGS</strong>. <span
                        data-lang-key="footer.all_rights">All Rights Reserved.</span>
                </div>
